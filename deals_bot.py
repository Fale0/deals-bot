...
# --- Источники RSS ---
RSS_FEEDS = [
    {"url": "https://brobank.ru/promo/feed/", "name": "BroBank (Акции банков)", "category": "🏦 Банки"},
    {"url": "https://www.ixbt.com/export/rss/lastnews.xml", "name": "iXBT (Новости электроники)", "category": "💻 Электроника"},
    {"url": "https://3dnews.ru/news/rss/", "name": "3DNews (IT-скидки)", "category": "💻 Электроника"},
    {"url": "https://promokodus.com/rss", "name": "Promokodus (Промокоды)", "category": "🛒 Маркетплейсы"},
    {"url": "https://vc.ru/feed", "name": "VC.ru (Лайфхаки и финансы)", "category": "💡 Лайфхаки"},
]
...
def start_background_tasks():
    """Запуск всех фоновых задач ПОСЛЕ того как Flask уже работает"""
...
if __name__ == "__main__":
    ...
    print(f"🌐 Flask стартует на 0.0.0.0:{port}")
