...
COSMETOLOGY_KEYWORDS = [
    "study", "research", "clinical", "trial", "efficacy", "safety",
    "ingredient", "formulation", "skin barrier", "collagen", "elastin",
    "hyaluronic acid", "retinol", "peptide", "antioxidant", "anti-aging",
    "wrinkle reduction", "pigmentation", "melasma", "acne treatment",
    "rosacea", "psoriasis", "eczema", "wound healing", "regeneration",
    "stem cell", "growth factor", "laser", "light therapy",
    "microneedling", "chemical peel", "botulinum toxin", "filler",
    "cosmeceutical", "sunscreen", "uv protection",
    "исследование", "клиническое", "испытание", "эффективность",
...
def send_combined_news(chat_id: int):
    send_message(chat_id, "🔍 Загружаю последние новости (медицина + прорывы в косметологии)... ⏳")
    articles = fetch_combined_news(limit=10)
    if not articles:
        send_message(chat_id, "😕 Новостей пока нет. Попробуйте позже.")
...
@app.route("/")
def index():
    return "Medical & Cosmetology News Bot"
